...
export const NotFound = () => {
  ...
  return (
    <div className="min-h-[75vh] flex flex-col items-center justify-center text-center px-4 py-16 animate-luxury-fade relative overflow-hidden">
      ...
      <div 
        aria-hidden="true" 
        className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-96 h-96 bg-gradient-to-tr from-zinc-700/10 via-neutral-750/10 to-transparent rounded-full blur-3xl pointer-events-none" 
      />
      ...
      <div className="relative mb-8">
        <div className="w-28 h-28 sm:w-36 sm:h-36 rounded-full border border-neutral-800 bg-[#0E0E12] flex items-center justify-center shadow-2xl relative">
          ...
          <div className="absolute inset-0 rounded-full border border-zinc-700/30 animate-pulse pointer-events-none" />
        </div>
      ...
      {/* Numerical Badge */}
      <p className="text-xs uppercase tracking-[0.3em] font-mono text-zinc-400 mb-2">
