      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
        ...
        <nav aria-label="Legal and Compliance Navigation" className="flex flex-wrap items-center gap-x-5 gap-y-2 text-xs">
          ...
          <button
            ...
            className="hover:text-white transition-colors text-neutral-400 hover:text-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white rounded py-0.5"
          >
            Cookie Settings
          </button>
          <button
